...
public class TestDatabaseOperations {
	...
	public static void main(String[] args) {
		...
		List<Employee> employees=CSVLoaderEmployee.loadEmployee("/home/gaganmani/Eclipse workspace/ADO-HW1/src/employee.csv");
		List<Department> dept=CSVLoaderDept.loadDept("/home/gaganmani/Eclipse workspace/ADO-HW1/src/dept.csv");
